...
!! Modified by Gerard Harkema for private use, Thanks to Wouter Bake !! 
...
* Install Python
* Git clone the source with `git clone https://gitlab.com/gharkema/Omnik-Data-Logger.git`
* Copy the config-org.cfg to config.cfg !! Niet nodig !!!
...
`* * * * * /usr/bin/python /home/gerard/Omnik-Data-Logger/OmnikExport.py`
